...
export const JUMPING_KANGAROO_ICON_SVG = `<svg viewBox="0 0 2048 2048" fill="currentColor" style="width: 100%; height: 100%;"><use href="#jumping-kangaroo-def"></use></svg>`;
...
export const CSS_CLASSES = {
    ...
    ICON_ONLY_GRID: 'icon-only-grid',
    COMMAND_GRID: 'command-grid',
    COMMAND_ICON: 'command-icon',
    COMMAND_GRID_ITEM: 'command-grid-item',
    AI_TEXT_BODY: 'ai-text-body',
    AI_HEADER_1: 'ai-header-1',
    AI_HEADER_2: 'ai-header-2',
    AI_HEADER_3: 'ai-header-3',
    COMPOSITE_ICON: 'composite-icon',
    VISUAL_BTN: 'visual-btn',
...
export const IDS = {
    ...
    SUPER_BRING_FORWARD_FY: 'super-bf-fy',
    SUPER_USED_AMOUNT: 'super-used-amount',
    ...
    SUPER_LIVE_PENSION_BALANCE: 'super-live-pension-balance',
    SUPER_LIVE_ACCUMULATION_BALANCE: 'super-live-accumulation-balance',
    SUPER_MINPENSION_CHECKBOX: 'super-minpension-checkbox',
    SUPER_ACC_SAFETY_CHECKBOX: 'super-acc-safety-checkbox',
